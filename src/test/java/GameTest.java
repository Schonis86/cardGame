...
class GameTest {
    ...
    List<GameCard> getDeck(int deckSize) {
        ...
        for (int i = 0; i < deckSize; i++) {
            CreatureCard card = new CreatureCard(10, "Ali", 5, 2, 2, 2, null, false);
            deck.add(card);
        }
        return deck;
    }
    ...
    void isPlayerOutOfCards(){
        ...
        List<CreatureCard> tempCardsOnTableWithCards = Arrays.asList(new CreatureCard(10,"Lina",1,1,2,9, null, false));
